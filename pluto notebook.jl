...
# ╔═╡ 62b93ade-2e0f-11f0-294d-e32d7c01bac8
begin
	using MarketData
	
	data = yahoo(:AAPL, YahooOpt(period1 = DateTime(2018, 1, 1)))
end

# ╔═╡ 317e4ea2-ccd0-4aa0-a9a5-d245b58f7419
begin
	using Plots
	Plots.plot(data.Close, label="Closing Prices", xlabel="Date", ylabel="Price (USD)")
end
...
manifest_format = "2.0"
project_hash = "2d07cd8a08457d92551cf1942cd960d886918550"
